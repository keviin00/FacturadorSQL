use facturadorbk; 
 ...
 create  or replace view producto_bk as -- CREO O REMPLAZO LA VIEWS PRODUCTO_BK 
    (select ID_Producto,Marca,Modelo,Serial_number,Precio,Producto_disponible  -- SELECCIONAMOS LOS CAMPOS ID_PRODUCTO,MARCA,MODELO,SERIAL_NUMBER,PRECIO Y PRODUCTO_DISPONIBLE
 ...
 select  provinciasbk.provincia,localidadesbk.localidad -- SELECCIONAMOS LA TABLA PROVINCIASBK EL CAMPO PROVINCIA Y DE LA TABLA LOCALIDADESBK EL CAMPO LOCALIDAD
 from localidadesbk inner join provinciasbk 
 on localidadesbk.ID_provincia=provinciasbk.id_provincia); -- DE LA TABLA LOCALIDADESBK LA UNIMOS CON LA TABLA PROVINCIASBK DONDE EN LOCALIDADESBK EL ID_PROVINCIA SEA IGUAL AL ID_PROVINCIA DE LA TABLA PROVINCIASBK
...
create  or replace view recibio_bk as -- CREO O REMPLAZO LA VIEWS RECIBO_BK  
	(select  productobk.Marca,productobk.modelo,productobk.serial_number,productobk.precio,productobk.producto_disponible,   -- SELECCIONAMOS LA TABLA PRODUCTOBK EL CAMPO MARCA,MODELO,SERIAL_NUMBER,PRECIO,PRODUCTO_DISPONIBLE
  ...
  (   select  recibobk.ID_Recibo, -- SELECCIONAMOS DE LA TABLA RECIBOBK EL CAMPO ID_RECIBO
     productobk.Marca,productobk.modelo,productobk.serial_number,productobk.precio,productobk.producto_disponible, -- SELECCIONAMOS LA TABLA PRODUCTOBK EL CAMPO MARCA,MODELO,SERIAL_NUMBER,PRECIO,PRODUCTO_DISPONIBLE
      clientebk.nombre,clientebk.apellido,clientebk.dni,clientebk.email, -- SELECCIONAMOS LA TABLA CLIENTEBK EL CAMPO NOMBRE,APELLIDO,DNI,EMAL
      provinciasbk.provincia,  -- SELECCIONAMOS LA TABLA PROVINCIASBK EL CAMPO PROVINCIA	
      localidadesbk.localidad  -- SELECCIONAMOS LA TABLA LOCALIDADESBK EL CAMPOLOCALIDAD
	  from recibobk inner join productobk -- DE LA TABLA RECIBOBK LA UNIMOS CON LA TABLA PRODUCTOBK
