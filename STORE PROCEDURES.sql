use facturadorbk;
      -- STORED PROCEDURES I
DROP PROCEDURE IF EXISTS PS_MOSTRAR_PRODUCTOS ; -- BORRAMOS EL SP SI EXISTE
delimiter //
CREATE PROCEDURE PS_MOSTRAR_PRODUCTOS () -- CREAMOS EL SP PARA MOSTRAR TABLAS 
begin
	SELECT * FROM PRODUCTOBK ; -- SELECIONAMOS LA TABLA QUE QUEREMOS MOSTRAR 
 end //
 delimiter ;
CALL PS_MOSTRAR_PRODUCTOS ;-- LLAMAMOS A LA SP CREADA
