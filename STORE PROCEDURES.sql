...
delimiter //
CREATE PROCEDURE PS_INSERTDATOS_CLIENTES (IN NOMBRE_P VARCHAR(250), IN APELLIDO_P VARCHAR(250), IN EMAIL_P VARCHAR(250), IN DNI_P INT, IN PROVINCIA_P VARCHAR (250), IN LOCALIDAD_P VARCHAR (250) ) --  CREAMOS EL SP PARA INSERTAR DATOS EN LAS TABLAS Y DEFINIMOS QUE TIPOS DE DATOS VAMOS A INGRESAR
begin
...
WHERE ID_CLIENTE = ID_CLIENTE_P ; -- DEFINIMOS QUE SI EL VALOR ID_PRODUCTO O EL QUE QUERRAMOS BORRAR, ES IGUAL AL DATO INGRESADO BORRA TODOS LOS CAMPOS DE ESE CAMPO
 ...
 delimiter ;
	...
	CALL PS_DELET_VALUES_CLIENTES (9); -- LLAMAMOS A LA SP Y DEFINIMOS QUE DATO QUEREMOS BORRAR 