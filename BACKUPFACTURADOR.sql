...
--
-- Host: 127.0.0.1    Database: facturadorbk
-- ------------------------------------------------------
...
--
-- Temporary view structure for view `cliente_bk`
--

DROP TABLE IF EXISTS `cliente_bk`;
/*!50001 DROP VIEW IF EXISTS `cliente_bk`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `cliente_bk` AS SELECT 
 1 AS `nombre`,
 1 AS `apellido`,
 1 AS `email`,
 1 AS `dni`,
...
--
-- Table structure for table `clientebk`
--
...
--
-- Dumping data for table `clientebk`
--

LOCK TABLES `clientebk` WRITE;
/*!40000 ALTER TABLE `clientebk` DISABLE KEYS */;
INSERT INTO `clientebk` VALUES (1,'Kevin','Ayala','kevin.eliasayala@gmail.com',43011615,'Buenos Aires','Caseros'),(2,'Lautaro','Bazzola','lautaro.bazzola@gmail.com',39592309,'Tierra del Fuego','Ushuaia'),(3,'Daniel','Matalone','daniel.matalone@gmail.com',32834933,'Misiones','Iguazú'),(4,'Nicolas','Torres','torresnicolasezequiel23@outlook.com',41215267,'Formosa','Las Lomitas'),(5,'Laura','Matalone','matalonelaura@gmail.com',28800896,'Entre Rios','Parana'),(6,'Melina','Rios','meeelina.rios@gmail.com',44304161,'Salta','Angastaco'),(7,'Agustin','Di Pilato','agdipilato@outlook.com',40242281,'La Pampa','Arata'),(8,'Martin','Aldosibi','Aldosibi.Martin@gmail.com',41598762,'Buenos Aires','Palomar'),(9,'Marco','Polo','Marco.Polo@gmail.com',24569873,'Buenos Aires','Palomar');
/*!40000 ALTER TABLE `clientebk` ENABLE KEYS */;
UNLOCK TABLES;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER TRG_CLIENTES AFTER INSERT ON CLIENTEBK -- CREAMOS EL TRG QUE SE VA A ENCARGAR DE LLEVAR UN CONTROL DE LO DATOS INGRESADOS A LA TABLA CLIENTEBK DESPÚES DE QUE SE HAGA
FOR EACH ROW 
BEGIN 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER TRG_UPDATE_CLIENTES_P BEFORE UPDATE ON CLIENTEBK 
-- CREAMOS EL TRG QUE SE VA A ENCARGAR DE LLEVAR UN CONTROL DE LAS ACTUALIZACIONES DE LOS DATOS A LA TABLA CLIENTEBK EN CASO DE QUE EL CLIENTE SE MUDE DE PROVINCIA
FOR EACH ROW 
BEGIN 
...
-- ACA VA A INGRESAR LOS VALORES A LA TABLA DE AUDITORIA DEL UPDATE DEL CLIENTE POR ESO GUARDAN LOS DATOS VIEJOS QUE ERA ANTES DEL UPDATE Y LOS DATOS NUEVOS QUE ES DESPUES DEL MISMO 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER TRG_UPDATE_CLIENTES_L BEFORE UPDATE ON CLIENTEBK 
-- CREAMOS EL TRG QUE SE VA A ENCARGAR DE LLEVAR UN CONTROL DE LAS ACTUALIZACIONES DE LOS DATOS A LA TABLA CLIENTEBK EN CASO DE QUE EL CLIENTE SE MUDE DE LOCALIDAD
FOR EACH ROW 
BEGIN 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER TRG_UPDATE_CLIENTES_NOMBRE BEFORE UPDATE ON CLIENTEBK 
-- CREAMOS EL TRG QUE SE VA A ENCARGAR DE LLEVAR UN CONTROL DE LAS ACTUALIZACIONES DE LOS DATOS A LA TABLA CLIENTEBK EN CASO DE QUE EL CLIENTE SE CAMBIE EL NOMBRE
FOR EACH ROW 
BEGIN 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER TRG_UPDATE_CLIENTES_EMAIL BEFORE UPDATE ON CLIENTEBK 
-- CREAMOS EL TRG QUE SE VA A ENCARGAR DE LLEVAR UN CONTROL DE LAS ACTUALIZACIONES DE LOS DATOS A LA TABLA CLIENTEBK EN CASO DE QUE EL CLIENTE CAMBIE EL EMAIL
FOR EACH ROW 
BEGIN 
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER TRG_CLIENTES_DELETE AFTER DELETE ON CLIENTEBK -- CREAMOS EL TRG QUE SE VA A ENCARGAR DE LLEVAR UN CONTROL POR SI HAY QUE BORRAR ALGUN CLIENTE 
FOR EACH ROW 
BEGIN 
...
--
-- Temporary view structure for view `garantia_bk`
--

DROP TABLE IF EXISTS `garantia_bk`;
/*!50001 DROP VIEW IF EXISTS `garantia_bk`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `garantia_bk` AS SELECT 
 1 AS `ID_Recibo`,
 1 AS `Marca`,
 1 AS `modelo`,
 1 AS `serial_number`,
 1 AS `precio`,
 1 AS `producto_disponible`,
 1 AS `nombre`,
 1 AS `apellido`,
 1 AS `dni`,
 1 AS `email`,
...
--
-- Table structure for table `garantiabk`
--
...
CREATE TABLE `garantiabk` (
  ...
  CONSTRAINT `garantiabk_ibfk_1` FOREIGN KEY (`ID_Producto`) REFERENCES `productobk` (`ID_Producto`),
  CONSTRAINT `garantiabk_ibfk_2` FOREIGN KEY (`ID_Stock`) REFERENCES `stockbk` (`ID_Stock`),
  CONSTRAINT `garantiabk_ibfk_3` FOREIGN KEY (`ID_Cliente`) REFERENCES `clientebk` (`ID_Cliente`),
  CONSTRAINT `garantiabk_ibfk_4` FOREIGN KEY (`ID_Recibo`) REFERENCES `recibobk` (`ID_Recibo`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `garantiabk`
--

LOCK TABLES `garantiabk` WRITE;
/*!40000 ALTER TABLE `garantiabk` DISABLE KEYS */;
INSERT INTO `garantiabk` VALUES (1,1,1,1,2),(2,4,2,2,6),(3,5,3,3,7),(4,5,3,4,3),(5,4,2,5,5),(6,1,1,6,1),(7,1,1,7,8),(8,7,7,8,9);
/*!40000 ALTER TABLE `garantiabk` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `localidades_bk`
--

DROP TABLE IF EXISTS `localidades_bk`;
/*!50001 DROP VIEW IF EXISTS `localidades_bk`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `localidades_bk` AS SELECT 
 1 AS `provincia`,
 1 AS `localidad`*/;
SET character_set_client = @saved_cs_client;

--
-- Table structure for table `localidadesbk`
--
...
CREATE TABLE `log_auditoria_clientes` (
  ...
  `CAMPO_NUEVO` varchar(3200) DEFAULT NULL,
...
--
-- Dumping data for table `log_auditoria_clientes`
--

LOCK TABLES `log_auditoria_clientes` WRITE;
/*!40000 ALTER TABLE `log_auditoria_clientes` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_auditoria_clientes` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `log_auditoria_clientes_actualizacion_email`
--

DROP TABLE IF EXISTS `log_auditoria_clientes_actualizacion_email`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_auditoria_clientes_actualizacion_email` (
  `ID_LOG_MAIL` int(11) NOT NULL AUTO_INCREMENT,
  `NOMBRE_DE_ACCION` varchar(10) DEFAULT NULL,
  `NOMBRE_TABLA` varchar(50) DEFAULT NULL,
  `CAMPO_VIEJO` varchar(3200) DEFAULT NULL,
  `CAMPO_NUEVO` varchar(3200) DEFAULT NULL,
  `USUARIO` varchar(100) DEFAULT NULL,
  `FECHA_INSCRIPCION` date DEFAULT NULL,
...
--
-- Dumping data for table `log_auditoria_clientes_actualizacion_email`
--

LOCK TABLES `log_auditoria_clientes_actualizacion_email` WRITE;
/*!40000 ALTER TABLE `log_auditoria_clientes_actualizacion_email` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_auditoria_clientes_actualizacion_email` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `log_auditoria_clientes_actualizacion_l`
--

DROP TABLE IF EXISTS `log_auditoria_clientes_actualizacion_l`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_auditoria_clientes_actualizacion_l` (
  `ID_LOG_L` int(11) NOT NULL AUTO_INCREMENT,
  `NOMBRE_DE_ACCION` varchar(10) DEFAULT NULL,
  `NOMBRE_TABLA` varchar(50) DEFAULT NULL,
  `CAMPO_VIEJO` varchar(3200) DEFAULT NULL,
  `CAMPO_NUEVO` varchar(3200) DEFAULT NULL,
  `USUARIO` varchar(100) DEFAULT NULL,
  `FECHA_INSCRIPCION` date DEFAULT NULL,
  PRIMARY KEY (`ID_LOG_L`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `log_auditoria_clientes_actualizacion_l`
--

LOCK TABLES `log_auditoria_clientes_actualizacion_l` WRITE;
/*!40000 ALTER TABLE `log_auditoria_clientes_actualizacion_l` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_auditoria_clientes_actualizacion_l` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `log_auditoria_clientes_actualizacion_nombre`
--

DROP TABLE IF EXISTS `log_auditoria_clientes_actualizacion_nombre`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_auditoria_clientes_actualizacion_nombre` (
  `ID_LOG_NOMBRE` int(11) NOT NULL AUTO_INCREMENT,
  `NOMBRE_DE_ACCION` varchar(10) DEFAULT NULL,
  `NOMBRE_TABLA` varchar(50) DEFAULT NULL,
  `CAMPO_VIEJO` varchar(3200) DEFAULT NULL,
  `CAMPO_NUEVO` varchar(3200) DEFAULT NULL,
  `USUARIO` varchar(100) DEFAULT NULL,
  `FECHA_INSCRIPCION` date DEFAULT NULL,
  PRIMARY KEY (`ID_LOG_NOMBRE`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `log_auditoria_clientes_actualizacion_nombre`
--

LOCK TABLES `log_auditoria_clientes_actualizacion_nombre` WRITE;
/*!40000 ALTER TABLE `log_auditoria_clientes_actualizacion_nombre` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_auditoria_clientes_actualizacion_nombre` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `log_auditoria_clientes_actualizacion_p`
--

DROP TABLE IF EXISTS `log_auditoria_clientes_actualizacion_p`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_auditoria_clientes_actualizacion_p` (
  `ID_LOG_P` int(11) NOT NULL AUTO_INCREMENT,
  `NOMBRE_DE_ACCION` varchar(10) DEFAULT NULL,
  `NOMBRE_TABLA` varchar(50) DEFAULT NULL,
  `CAMPO_VIEJO` varchar(3200) DEFAULT NULL,
  `CAMPO_NUEVO` varchar(3200) DEFAULT NULL,
...
--
-- Dumping data for table `log_auditoria_clientes_actualizacion_p`
--

LOCK TABLES `log_auditoria_clientes_actualizacion_p` WRITE;
/*!40000 ALTER TABLE `log_auditoria_clientes_actualizacion_p` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_auditoria_clientes_actualizacion_p` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `log_auditoria_delete_cliente`
--

DROP TABLE IF EXISTS `log_auditoria_delete_cliente`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_auditoria_delete_cliente` (
  `ID_LOG_DEL` int(11) NOT NULL AUTO_INCREMENT,
  `NOMBRE_DE_ACCION` varchar(10) DEFAULT NULL,
  `NOMBRE_TABLA` varchar(50) DEFAULT NULL,
  `CAMPO_VIEJO` varchar(3200) DEFAULT NULL,
  `USUARIO` varchar(100) DEFAULT NULL,
  `FECHA_INSCRIPCION` date DEFAULT NULL,
  PRIMARY KEY (`ID_LOG_DEL`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `log_auditoria_delete_cliente`
--

LOCK TABLES `log_auditoria_delete_cliente` WRITE;
/*!40000 ALTER TABLE `log_auditoria_delete_cliente` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_auditoria_delete_cliente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `producto_bk`
--

DROP TABLE IF EXISTS `producto_bk`;
/*!50001 DROP VIEW IF EXISTS `producto_bk`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `producto_bk` AS SELECT 
 1 AS `ID_Producto`,
 1 AS `Marca`,
 1 AS `Modelo`,
 1 AS `Serial_number`,
...
--
-- Table structure for table `productobk`
--
...
CREATE TABLE `productobk` (
  ...
  `producto_disponible` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`ID_Producto`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `productobk`
--

LOCK TABLES `productobk` WRITE;
/*!40000 ALTER TABLE `productobk` DISABLE KEYS */;
INSERT INTO `productobk` VALUES (1,'Celular','Iphone','F2LXHGEKKPHG',250000,1),(2,'Corsair','Vengance','XbCHHKPS',15000,0),(3,'Asus','Z590Prime','B4Etcp8o',35000,0),(4,'Gefast','Gf26','JytuJJqp',25000,1),(5,'Naxido','XB-6255M','213361461',20000,1),(6,'Coradir','27Fkal','WeDUqBM9',67000,0),(7,'Celular','Sony','ASD48965RS',250000,1),(8,'XBOX','JOSTYCK','M1106906007',30500,1);
/*!40000 ALTER TABLE `productobk` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `provincias_bk`
--

DROP TABLE IF EXISTS `provincias_bk`;
/*!50001 DROP VIEW IF EXISTS `provincias_bk`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `provincias_bk` AS SELECT 
 1 AS `provincia`*/;
SET character_set_client = @saved_cs_client;

--
-- Table structure for table `provinciasbk`
--
...
--
-- Dumping data for table `provinciasbk`
--

LOCK TABLES `provinciasbk` WRITE;
/*!40000 ALTER TABLE `provinciasbk` DISABLE KEYS */;
INSERT INTO `provinciasbk` VALUES (1,'Buenos Aires'),(2,'Buenos Aires-GBA'),(3,'Capital Federal'),(4,'Catamarca'),(5,'Chaco'),(6,'Chubut'),(7,'Córdoba'),(8,'Corrientes'),(9,'Entre Ríos'),(10,'Formosa'),(11,'Jujuy'),(12,'La Pampa'),(13,'La Rioja'),(14,'Mendoza'),(15,'Misiones'),(16,'Neuquén'),(17,'Río Negro'),(18,'Salta'),(19,'San Juan'),(20,'San Luis'),(21,'Santa Cruz'),(22,'Santa Fe'),(23,'Santiago del Estero'),(24,'Tierra del Fuego'),(25,'Tucumán');
/*!40000 ALTER TABLE `provinciasbk` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `recibio_bk`
--

DROP TABLE IF EXISTS `recibio_bk`;
/*!50001 DROP VIEW IF EXISTS `recibio_bk`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `recibio_bk` AS SELECT 
 1 AS `Marca`,
 1 AS `modelo`,
 1 AS `serial_number`,
 1 AS `precio`,
...
--
-- Table structure for table `recibobk`
--
...
CREATE TABLE `recibobk` (
  ...
  KEY `ID_Producto` (`ID_Producto`),
  KEY `ID_Provincia` (`ID_Provincia`),
  KEY `ID_Localidades` (`ID_Localidades`),
  CONSTRAINT `recibobk_ibfk_1` FOREIGN KEY (`ID_Cliente`) REFERENCES `clientebk` (`ID_Cliente`),
  CONSTRAINT `recibobk_ibfk_2` FOREIGN KEY (`ID_Stock`) REFERENCES `stockbk` (`ID_Stock`),
  CONSTRAINT `recibobk_ibfk_3` FOREIGN KEY (`ID_Producto`) REFERENCES `productobk` (`ID_Producto`),
  CONSTRAINT `recibobk_ibfk_4` FOREIGN KEY (`ID_Provincia`) REFERENCES `provinciasbk` (`ID_Provincia`),
  CONSTRAINT `recibobk_ibfk_5` FOREIGN KEY (`ID_Localidades`) REFERENCES `localidadesbk` (`ID_Localidades`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `recibobk`
--

LOCK TABLES `recibobk` WRITE;
/*!40000 ALTER TABLE `recibobk` DISABLE KEYS */;
INSERT INTO `recibobk` VALUES (1,1,1,2,24,2272),(2,4,2,6,18,1672),(3,5,3,7,12,1349),(4,5,3,3,15,1503),(5,4,2,5,9,1166),(6,1,1,1,2,163),(7,1,1,8,2,176),(8,7,7,9,2,176);
/*!40000 ALTER TABLE `recibobk` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `stock_bk`
--

DROP TABLE IF EXISTS `stock_bk`;
/*!50001 DROP VIEW IF EXISTS `stock_bk`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `stock_bk` AS SELECT 
 1 AS `Marca`,
 1 AS `modelo`,
 1 AS `cantidad`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Table structure for table `stockbk`
--
...
CREATE TABLE `stockbk` (
  ...
  KEY `ID_Producto` (`ID_Producto`),
  CONSTRAINT `stockbk_ibfk_1` FOREIGN KEY (`ID_Producto`) REFERENCES `productobk` (`ID_Producto`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `stockbk`
--

LOCK TABLES `stockbk` WRITE;
/*!40000 ALTER TABLE `stockbk` DISABLE KEYS */;
INSERT INTO `stockbk` VALUES (1,1,80),(2,4,10),(3,5,35),(4,2,0),(5,3,0),(6,6,0),(7,7,100);
/*!40000 ALTER TABLE `stockbk` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'facturadorbk'
--

--
-- Dumping routines for database 'facturadorbk'
--
/*!50003 DROP FUNCTION IF EXISTS `FN_LocalidClienteBK` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `FN_LocalidClienteBK`(NOMBRE CHAR(255) ) RETURNS int(11)
    DETERMINISTIC
begin
	DECLARE  NUMERO INT ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `FN_Productos_DisponibleBK` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `FN_Productos_DisponibleBK`(f_MARCA char(255), f_MODELO char(255)) RETURNS int(11)
    DETERMINISTIC
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `FN_Productos_MarcaBK` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `FN_Productos_MarcaBK`(PRODUCTOS CHAR(255) ) RETURNS char(255) CHARSET latin1
    DETERMINISTIC
begin
	DECLARE  NUMERO INT ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `FN_Productos_ModeloBK` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `FN_Productos_ModeloBK`(PRODUCTOS CHAR(255) ) RETURNS char(255) CHARSET latin1
    DETERMINISTIC
begin
	DECLARE  NUMERO INT ;
	select count(*)into NUMERO from productobk  -- BUSCAMOS EN LA TABLA PRODUCTOSBK
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `FN_ProvinciaClienteBK` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `FN_ProvinciaClienteBK`(NOMBRE CHAR(255) ) RETURNS int(11)
    DETERMINISTIC
begin
	DECLARE  NUMERO INT;
	select count(*) into Numero from clientebk  -- BUSCAMOS EN LA TABLA CLIENTE BK
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP FUNCTION IF EXISTS `FN_Recibobk` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `FN_Recibobk`(PRODUCTO varchar(500)) RETURNS int(11)
    DETERMINISTIC
begin
	DECLARE  NUMERO INT ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PS_DELET_VALUES_CLIENTES` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PS_DELET_VALUES_CLIENTES`(IN ID_CLIENTE_P INT)
begin
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PS_DELET_VALUES_PRODUCTOS` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PS_DELET_VALUES_PRODUCTOS`(IN ID_PRODUCTO_P INT)
begin
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PS_INSERTDATOS_CLIENTES` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PS_INSERTDATOS_CLIENTES`(IN NOMBRE_P VARCHAR(250), IN APELLIDO_P VARCHAR(250), IN EMAIL_P VARCHAR(250), IN DNI_P INT, 
IN PROVINCIA_P VARCHAR (250), IN LOCALIDAD_P VARCHAR (250) )
begin
	INSERT INTO CLIENTEBK (NOMBRE,APELLIDO,EMAIL,DNI,PROVINCIA,LOCALIDAD)	-- INGRESAMOS LOS DATOS SELECCIONAMOS LA TABLA Y DEFINIMOS EN QUE CAMPOS VAMOS A INGRESAR ESOS DATOS
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PS_INSERTDATOS_PRODUCTOS` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PS_INSERTDATOS_PRODUCTOS`(IN MARCA_P VARCHAR(250), IN MODELO_P VARCHAR(250), IN SERIAL_NUMBER_P VARCHAR(250), IN PRECIO_P INT, IN PRODUCTO_DISPONIBLE_p INT  )
begin
	INSERT INTO PRODUCTOBK (Marca,Modelo,Serial_number,Precio,Producto_disponible)	
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `PS_ORDER_PRODUCTOS_ASC_DES` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `PS_ORDER_PRODUCTOS_ASC_DES`(IN ORDENAR_POR_P VARCHAR(250), IN ORDERBY_DES_ASC_P  VARCHAR(250) )
begin
...
--
-- Final view structure for view `cliente_bk`
--
...
/*!50001 VIEW `cliente_bk` AS (select `clientebk`.`nombre` AS `nombre`,`clientebk`.`apellido` AS `apellido`,`clientebk`.`email` AS `email`,`clientebk`.`dni` AS `dni`,`clientebk`.`provincia` AS `provincia`,`clientebk`.`localidad` AS `localidad` from `clientebk` order by `clientebk`.`apellido`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `garantia_bk`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `garantia_bk` AS (select `recibobk`.`ID_Recibo` AS `ID_Recibo`,`productobk`.`marca` AS `Marca`,`productobk`.`modelo` AS `modelo`,`productobk`.`serial_number` AS `serial_number`,`productobk`.`precio` AS `precio`,`productobk`.`producto_disponible` AS `producto_disponible`,`clientebk`.`nombre` AS `nombre`,`clientebk`.`apellido` AS `apellido`,`clientebk`.`dni` AS `dni`,`clientebk`.`email` AS `email`,`provinciasbk`.`provincia` AS `provincia`,`localidadesbk`.`localidad` AS `localidad` from ((((`recibobk` join `productobk` on((`recibobk`.`ID_Producto` = `productobk`.`ID_Producto`))) join `clientebk` on((`recibobk`.`ID_Cliente` = `clientebk`.`ID_Cliente`))) join `provinciasbk` on((`recibobk`.`ID_Provincia` = `provinciasbk`.`ID_Provincia`))) join `localidadesbk` on((`recibobk`.`ID_Localidades` = `localidadesbk`.`ID_Localidades`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `localidades_bk`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `localidades_bk` AS (select `provinciasbk`.`provincia` AS `provincia`,`localidadesbk`.`localidad` AS `localidad` from (`localidadesbk` join `provinciasbk` on((`localidadesbk`.`ID_Provincia` = `provinciasbk`.`ID_Provincia`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `producto_bk`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `producto_bk` AS (select `productobk`.`ID_Producto` AS `ID_Producto`,`productobk`.`marca` AS `Marca`,`productobk`.`modelo` AS `Modelo`,`productobk`.`serial_number` AS `Serial_number`,`productobk`.`precio` AS `Precio`,`productobk`.`producto_disponible` AS `Producto_disponible` from `productobk` where (`productobk`.`producto_disponible` like '1%') order by `productobk`.`precio` desc) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `provincias_bk`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `provincias_bk` AS (select `provinciasbk`.`provincia` AS `provincia` from `provinciasbk` order by `provinciasbk`.`ID_Provincia`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `recibio_bk`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `recibio_bk` AS (select `productobk`.`marca` AS `Marca`,`productobk`.`modelo` AS `modelo`,`productobk`.`serial_number` AS `serial_number`,`productobk`.`precio` AS `precio`,`productobk`.`producto_disponible` AS `producto_disponible`,`clientebk`.`nombre` AS `nombre`,`clientebk`.`apellido` AS `apellido`,`clientebk`.`dni` AS `dni`,`clientebk`.`email` AS `email`,`provinciasbk`.`provincia` AS `provincia`,`localidadesbk`.`localidad` AS `localidad` from ((((`recibobk` join `productobk` on((`recibobk`.`ID_Producto` = `productobk`.`ID_Producto`))) join `clientebk` on((`recibobk`.`ID_Cliente` = `clientebk`.`ID_Cliente`))) join `provinciasbk` on((`recibobk`.`ID_Provincia` = `provinciasbk`.`ID_Provincia`))) join `localidadesbk` on((`recibobk`.`ID_Localidades` = `localidadesbk`.`ID_Localidades`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `stock_bk`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `stock_bk` AS (select `productobk`.`marca` AS `Marca`,`productobk`.`modelo` AS `modelo`,`stockbk`.`cantidad` AS `cantidad` from (`stockbk` join `productobk` on((`stockbk`.`ID_Producto` = `productobk`.`ID_Producto`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2022-09-05  8:47:57
